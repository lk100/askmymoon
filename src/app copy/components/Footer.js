        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-10 sm:gap-8">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-sm text-[#5C5875]">
              <li><Link href="/blogs" className="hover:text-[#4A3FCF] transition-colors">Blog</Link></li>
              <li><Link href="/consultation" className="hover:text-[#4A3FCF] transition-colors">Consultation</Link></li>
              <li><Link href="/about" className="hover:text-[#4A3FCF] transition-colors">About</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-sm text-[#5C5875]">
              <li><Link href="/terms" className="hover:text-[#4A3FCF] transition-colors">Terms and conditions</Link></li>
              <li><Link href="/privacy" className="hover:text-[#4A3FCF] transition-colors">Privacy policy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-sm text-[#5C5875]">
              <li className="inline-flex items-center gap-2">
                ...
                <a href="https://instagram.com/askmymoon" target="_blank" rel="noopener noreferrer" className="hover:text-[#4A3FCF] transition-colors">@askmymoon</a>
              </li>
              <li className="inline-flex items-center gap-2">
                <Camera className="w-4 h-4" />
                <a href="https://instagram.com/_13verse" target="_blank" rel="noopener noreferrer" className="hover:text-[#4A3FCF] transition-colors">@_13verse</a>
              </li>
            </ul>
          </div>
        </div>
